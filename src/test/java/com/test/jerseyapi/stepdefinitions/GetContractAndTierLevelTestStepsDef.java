...
import com.test.jerseyapi.model.TestResponse;
...
public class GetContractAndTierLevelTestStepsDef {
	...
	HttpEntity<TestResponse> response;

	Configurations configs;

	private RestTemplate restTemplate;
	
	HttpEntity<String> responseAsString;
	...
	public void get_contract_edit_service_called_via_postman() throws Throwable {
		...
		response = restTemplate.exchange(builder.toUriString(), HttpMethod.GET, null, TestResponse.class);
	}
	...
	public void get_contract_receives_status_code_of_200() throws Throwable {
		assertEquals("Http Response should be 200 ", configs.getSuccessStatusCode(),
				response.getBody().getStatus().intValue());
	}
	...
	public void get_contract_service_called_via_postman_no_params() throws Throwable {
		...
		response = restTemplate.exchange(builder.toUriString(), HttpMethod.GET, entity, TestResponse.class);
	}
	...
	public void the_client_calls_resetrates() throws Throwable {
		...
		response = restTemplate.exchange(builder.toUriString(), HttpMethod.POST, entity, TestResponse.class);
	...
	public void the_get_contract_service_call_should_return_the_success_response() {
		assertEquals("Http Response should be 200 ", configs.getSuccessStatusCode(), response.getBody().getStatus().intValue());
	}
